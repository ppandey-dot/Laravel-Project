                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" action="<?php echo e(route('vendor-invoice.store')); ?>" class="needs-validation pb-2" novalidate="">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="row my-3">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input name="email" type="text" class="form-control border-bottom"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-9">
                                                ...
                                                <input name="bank_address" type="text" class="form-control border-bottom"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-4 border p-2">
                                                <input name="total_amount" class="form-control" type="text" id="totalInput"
                                ...
                                <div class="row mt-3 px-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input name="declartion" type="text" class="form-control border-bottom"
                                                id="validationCustom05" placeholder="Declaration(if any)">
                                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel-project\gst_billing\resources\views/vendor-invoice/create.blade.php ENDPATH**/ ?>