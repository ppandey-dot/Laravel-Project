...
<head>
    ...
    <!-- App css -->
    <link href="<?php echo e(asset('public/assets/css/bootstrap-creative.min.css')); ?>" rel="stylesheet" type="text/css" id="bs-default-stylesheet" />
    <link href="<?php echo e(asset('public/assets/css/app-creative.min.css')); ?>" rel="stylesheet" type="text/css" id="app-default-stylesheet" />

    <link href="<?php echo e(asset('public/assets/css/bootstrap-creative-dark.min.css')); ?>" rel="stylesheet" type="text/css" id="bs-dark-stylesheet"
        disabled />
    <link href="<?php echo e(asset('public/assets/css/app-creative-dark.min.css')); ?>" rel="stylesheet" type="text/css" id="app-dark-stylesheet"
        disabled />
...
<body data-layout-mode="detached"
    ...
    <div id="wrapper">
        ...
        <!-- Plugins js-->
        <script src="<?php echo e(asset('public/assets/libs/flatpickr/flatpickr.min.js')); ?>"></script>
        <script src="<?php echo e(asset('public/assets/libs/apexcharts/apexcharts.min.js')); ?>"></script>

        <!-- Dashboar 1 init js-->
        <script src="<?php echo e(asset('public/assets/js/pages/dashboard-1.init.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\laravel-project\gst_billing\resources\views/vendor-invoice/print.blade.php ENDPATH**/ ?>