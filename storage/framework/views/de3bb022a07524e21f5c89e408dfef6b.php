                        ...
                        <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100 table-bordered"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e(date("d-m-y", strtotime($bill->invoice_date))); ?>
                                    ...
                                    <td>
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(route('delete',['gst_bill', $bill->id])); ?>"><i
                                                        class="mdi mdi-delete mr-2 text-muted font-18 vertical-middle"></i>Delete</a>
                                                <a class="dropdown-item" href="<?php echo e(route('print-gst-bill', $bill->id)); ?>"><i
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-project\gst_billing\resources\views/gst/manage-gst-bill.blade.php ENDPATH**/ ?>